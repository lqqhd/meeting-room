Component({
    ...
    methods: {
        ...
        toggleType(){
            ...
            //发送事件监听
            this.triggerEvent('toggleType', this.data.toggleType);
        },
        //滚动模式
        ...
        lastMonth: function () {
            ...
            //发送事件监听
            this.triggerEvent('lastMonth', this.zero(year)+"-"+this.zero(month));
        },
        //下个月
        nextMonth: function () {
            ...
            //发送事件监听
            this.triggerEvent('nextMonth', this.zero(year)+"-"+this.zero(month));
        },
        //获取当月天数
